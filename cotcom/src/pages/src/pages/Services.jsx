  ...
  return (
    <div className="min-h-screen pt-20">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#003366] mb-4">Servicios Principales</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {servicesData.map((service, index) => (
              <Card
                key={service.id}
                className="group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-[#CCCCCC]/20 animate-in fade-in slide-in-from-bottom"
              ...
              >
                <CardHeader>
                  ...
                  <CardTitle className="text-xl text-[#003366] group-hover:text-[#FF6600] transition-colors duration-300">
                    {service.title}
                  </CardTitle>
                </CardHeader>
                <CardContent>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-[#003366] mb-4">Servicios Adicionales</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {additionalServices.map((service, index) => (
              <Card
                key={index}
                className="group hover:shadow-xl transition-all duration-500 border-[#CCCCCC]/20 animate-in fade-in"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <CardHeader>
                  <CardTitle className="text-2xl text-[#003366] group-hover:text-[#FF6600] transition-colors duration-300">
                    {service.title}
                  </CardTitle>
