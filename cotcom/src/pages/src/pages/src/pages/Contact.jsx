    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="relative h-96 flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center animate-in fade-in slide-in-from-bottom duration-700">
          ...
          <p className="text-xl text-[#CCCCCC] max-w-2xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="animate-in fade-in slide-in-from-left duration-700">
                <h2 className="text-3xl font-bold text-[#003366] mb-6">Información de Contacto</h2>
              ...
              {contactInfo.map((info, index) => (
                <Card
                  key={index}
                  className="group hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 border-[#CCCCCC]/20 animate-in fade-in slide-in-from-left"
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {info.link ? (
                          <a
                            href={info.link}
                            className="text-[#003366] hover:text-[#FF6600] transition-colors duration-300 break-words"
                          >
                            {info.value}
                          </a>
                        ) : (
                          <p className="text-[#003366] break-words">{info.value}</p>
                        )}
                      </div>
                    </div>
                  </CardContent>
              ...
              <div className="animate-in fade-in slide-in-from-left duration-700" style={{ animationDelay: '300ms' }}>
                <h3 className="text-xl font-semibold text-[#003366] mb-4">Síguenos</h3>
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <a
                      ...
                      className="w-12 h-12 bg-[#003366] hover:bg-[#FF6600] rounded-full flex items-center justify-center text-white transition-all duration-300 transform hover:scale-110"
                      title={social.name}
                    >
                      {social.icon}
                    </a>
            ...
            <div className="lg:col-span-2">
              <Card className="shadow-xl border-[#CCCCCC]/20 animate-in fade-in slide-in-from-right duration-700">
                <CardHeader>
                  <CardTitle className="text-3xl text-[#003366]">Envíanos un Mensaje</CardTitle>
                </CardHeader>
                <CardContent>
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="name" className="text-[#003366]">Nombre Completo</Label>
                        <Input
                          id="name"
                          name="name"
                          value={formData.name}
                          ...
                          required
                          className="border-[#CCCCCC] focus:border-[#FF6600] focus:ring-[#FF6600]"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="subject" className="text-[#003366]">Asunto</Label>
                      <Input
                        id="subject"
                        name="subject"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="message" className="text-[#003366]">Mensaje</Label>
                      <Textarea
                        id="message"
                        name="message"
                        ...
                        rows={6}
                        required
                        className="border-[#CCCCCC] focus:border-[#FF6600] focus:ring-[#FF6600] resize-none"
                      />
                    </div>
                    <Button
                      type="submit"
      ...
      <section className="h-96 bg-gray-200">
        <div className="w-full h-full flex items-center justify-center bg-[#003366]/10">
          <p className="text-[#003366] text-xl font-semibold">Mapa de ubicación</p>
        </div>
      </section>
    </div>
  );
