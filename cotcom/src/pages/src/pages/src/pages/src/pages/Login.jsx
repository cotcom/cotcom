...
const Login = () => {
  ...
  return (
    <div className="min-h-screen pt-20 flex items-center justify-center bg-gradient-to-br from-[#003366] via-[#003366]/95 to-[#003366]/90 relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-md mx-auto">
          <Card className="shadow-2xl border-[#CCCCCC]/20 animate-in fade-in slide-in-from-bottom duration-700">
            ...
            <CardContent className="space-y-6">
              ...
              <Button
                ...
                className="w-full bg-white hover:bg-gray-50 text-[#003366] border-2 border-[#CCCCCC] hover:border-[#FF6600] transition-all duration-300 transform hover:scale-105 py-6 text-lg font-medium"
              >
