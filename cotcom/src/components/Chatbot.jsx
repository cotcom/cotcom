...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {isOpen && (
        <Card
          className={`fixed bottom-6 right-6 z-50 shadow-2xl border-2 border-[#CCCCCC]/30 transition-all duration-300 ${
        ...
        >
          ...
          <div className="bg-[#003366] text-white p-4 rounded-t-lg flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#CCCCCC]">En línea</p>
              </div>
            </div>
          ...
          {!isMinimized && (
            <>
                ...
                <div className="space-y-4">
                      ...
                      <div
                        className={`max-w-[75%] rounded-2xl p-3 ${
                          message.sender === 'user'
                            ...
                            : 'bg-white text-gray-800 border border-[#CCCCCC]/30'
                        }`}
                      >
                  ...
                  {isTyping && (
                    <div className="flex justify-start animate-in fade-in duration-300">
                      <div className="bg-white text-gray-800 border border-[#CCCCCC]/30 rounded-2xl p-3">
              ...
              {/* Chat Input */}
              <div className="p-4 border-t border-[#CCCCCC]/30">
                <form onSubmit={handleSendMessage} className="flex space-x-2">
                  <Input
                    value={inputMessage}
                    onChange={(e) => setInputMessage(e.target.value)}
                    placeholder="Escribe tu mensaje..."
                    className="flex-1 border-[#CCCCCC] focus:border-[#FF6600] focus:ring-[#FF6600]"
                  />
                  <Button
                    type="submit"
