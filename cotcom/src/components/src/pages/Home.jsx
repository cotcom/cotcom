    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <Card
                key={index}
                className="text-center group hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border-[#CCCCCC]/20 animate-in fade-in slide-in-from-bottom"
              ...
              >
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#003366] mb-2 group-hover:text-[#FF6600] transition-colors duration-300">
                    {feature.title}
                  </h3>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {testimonials.map((testimonial, index) => (
              <Card
                key={index}
                className="group hover:shadow-xl transition-all duration-500 transform hover:-translate-y-2 border-[#CCCCCC]/20 animate-in fade-in slide-in-from-bottom"
                style={{ animationDelay: `${index * 100}ms` }}
              >
                <CardContent className="p-6">
      ...
      <section className="py-20 bg-[#003366] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-[#CCCCCC] mb-8 max-w-2xl mx-auto animate-in fade-in duration-700" style={{ animationDelay: '100ms' }}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in duration-700" style={{ animationDelay: '200ms' }}>
            ...
            <Link to="/contact">
              <Button
                size="lg"
                variant="outline"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-[#003366] text-lg px-8 py-6 transition-all duration-300 transform hover:scale-105"
              >
                Contáctanos
              </Button>
            </Link>
