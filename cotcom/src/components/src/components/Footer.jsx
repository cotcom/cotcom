        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300">
                  About
                </Link>
              </li>
              <li>
                <Link to="/services" className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300">
                  Services
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300">
                  Contact
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <a href={`mailto:${contactData.email}`} className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300 text-sm">
                  {contactData.email}
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Phone className="w-5 h-5 text-[#FF6600] mt-0.5 flex-shrink-0" />
                <a href={`tel:${contactData.phone}`} className="text-[#CCCCCC] hover:text-[#FF6600] transition-colors duration-300 text-sm">
                  {contactData.phone}
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-[#FF6600] mt-0.5 flex-shrink-0" />
                <span className="text-[#CCCCCC] text-sm">{contactData.address}</span>
              </li>
            </ul>
          </div>
