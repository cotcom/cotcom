      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-xl mx-auto mb-10">
          <Input
            ...
            className="h-12 text-lg border-[#CCCCCC] focus:border-[#FF6600] focus:ring-[#FF6600]"
          />
        </div>
        ...
        <Tabs defaultValue="Todos" className="w-full">
          <div className="overflow-x-auto mb-12">
            <TabsList className="inline-flex w-max bg-[#003366]/5 p-1 rounded-lg mb-4">
              <TabsTrigger
                value="Todos"
        ...
        <div className="text-center mt-12">
          <p className="text-gray-600">
            ...
            <span className="font-semibold text-[#003366]">{products.length}</span> productos
          </p>
        </div>
      </div>
    </section>
